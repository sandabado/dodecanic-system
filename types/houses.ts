...
export type HouseElement = "earth" | "water" | "fire" | "air" | "unassigned";
...
export const HOUSE_DEFINITIONS: Record<HouseNumber, HouseDefinition> = {
  1: { number: 1, name: "Ground", element: "earth", quincunxPrimary: "physical", archetype: "The Anchor", humanMeaning: "Your physical foundation, resources, and the body you inhabit.", activatesWhen: "You attend to your body, space, or material needs.", imbalance: "Neglect of the physical self, disembodiment, or material instability.", reflection: "You are here. Your feet touch the earth.", question: "What supports you right now?", mantra: "I am anchored. I am here.", current: "V" },
